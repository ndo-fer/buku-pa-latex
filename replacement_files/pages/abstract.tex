...
\textit{Experiments were conducted on 1,699,219 integrated FKRTL claims. The best configuration was achieved by XGBoost with the VIF branch and a threshold of 0.80, yielding a ROC-AUC of 0.999876, PR-AUC of 0.996046, F1-score of 0.952511, precision of 0.913917, recall of 0.994507, and MCC of 0.951883 against the pseudo-label target. It should be noted that all evaluation metrics in this study are computed against pseudo-labels as proxy targets, and therefore should not be interpreted as accuracy for verified actual fraud detection. Interpretability analysis indicates that cost-related features, grouping tariff, non-capitation service history, special CMG, and tariff ratios are key drivers of the risk score. Therefore, the proposed system has strong potential to support claim verification by prioritizing high-risk claims rather than issuing final fraud judgments.}
